...
class PastOrderFragment : Fragment() , OrderAdapter.OnItemClickListener {
            ...
            popupMenu.setOnMenuItemClickListener { item ->
                when (item.itemId) {
                    R.id.action_sort_by_date_asc -> {
                        val filteredListResult =
                            filteredList.value.sortedWith(compareBy { it.createdAt })
                    ...
                    R.id.action_sort_by_price_asc -> {
                        val filteredListResult =
                            filteredList.value.sortedWith(compareBy { it.totalPrice })
                        adapter.submitList(filteredListResult)
    ...
    override fun onItemClick(item: OrderResponse.AllOrder) {
       val action = OrdersFragmentDirections.actionOrdersFragmentToDetailsOrderFragment(item._id.toString() , "past")
